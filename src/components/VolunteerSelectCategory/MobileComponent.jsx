  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col w-full max-w-md px-4 py-12 space-y-4">
        ...
        {/* Category Buttons */}
        <CategoryButton text="Feed Food for Needy" route="/volunteer/feed-food" />
        <CategoryButton text="Feed for Stray Cats / Dogs" route="/volunteer/feed-stray" />
        <CategoryButton
          text="Provide Medicines to the Poor"
          route="/volunteer/provide-medicines"
        />
        <CategoryButton
          text="Sanitary Pads to Poor Girls"
          route="/volunteer/provide-sanitary"
        />
        <CategoryButton text="Clothes to Poor" route="/volunteer/clothes-to-poor" />
      </div>
